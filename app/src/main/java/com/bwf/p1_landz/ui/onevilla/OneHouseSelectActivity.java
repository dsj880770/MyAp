...
import com.bwf.p1_landz.ui.onlinevilla.LocationAdapter;
...
public class OneHouseSelectActivity extends BaseActivity{
...
//        paramlist.add(new ParamListBean("面积",false,mianji_paramList));
        paramlist.add(new ParamListBean("优惠",true,getTeSe()));
...
//                setSelectDatas(bean.get(i).childList,0);
        ...
        lv_location2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(bean.get(currentClickfristItem).name.equals("优惠")){
