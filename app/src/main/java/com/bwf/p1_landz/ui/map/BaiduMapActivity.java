...
public class BaiduMapActivity extends BaseActivity{
    ...
    public int getContentViewId() {
        ...
        return R.layout.baidumapactivity;
    }
    ...
    public void initView() {
        LocationResult = (TextView) findViewById(R.id.maptext);
        startLocation = (Button) findViewById(R.id.start_loc);
